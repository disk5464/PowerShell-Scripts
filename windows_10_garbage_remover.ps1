...
Function DisableWiFiSense {
	...
	Set-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\WlanSVC\AnqpCache\OsuRegistrationStatus" -Name "Value" -Type DWord -Value 0
	Set-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\DataCollection\Default\WifiAutoConnectConfig\AutoConnectEnabled" -Name "Value" -Type DWord -Value 0
}
...
Function EnableWiFiSense {
	...
	Set-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\WlanSVC\AnqpCache\OsuRegistrationStatus" -Name "Value" -Type DWord -Value 1
	Set-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\DataCollection\Default\WifiAutoConnectConfig\AutoConnectEnabled" -Name "Value" -Type DWord -Value 1
}
...
# Disable DMA for Bitlocker Sleep
Function DisableDMA {
	Write-Host "Disabling DMA for Bitlocker Sleep fix..."
	Set-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\PolicyManager\current\device\" -Name "AllowDirectMemoryAccess" -Type DWord -Value 0
}

# Enable DMA for Bitlocker Sleep
Function EnableDMA {
	Write-Host "Enabling DMA for Bitlocker Sleep fix..."
	Set-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\PolicyManager\current\device\" -Name "AllowDirectMemoryAccess" -Type DWord -Value 1
}
